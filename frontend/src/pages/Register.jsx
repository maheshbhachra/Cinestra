      ...
      <div className="h-screen bg-black flex overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 md:px-16">
          <div className="mb-8">
            ...
            <h2 className="text-white text-4xl font-bold mb-2">Join Cinestra</h2>
            <p className="text-gray-400">Track every movie. Share every opinion.</p>
          </div>
        ...
        {/* Right side — animated poster columns */}
        <div className="hidden lg:flex w-1/2 relative overflow-hidden gap-2 p-3">
          <div className="absolute inset-0 .bg-gradient-to-l from-black/10 to-black/70 z-10 pointer-events-none" />
